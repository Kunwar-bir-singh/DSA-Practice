...
class Solution{
    ...
    public static void create(Node root0, ArrayList<Integer> v, int i){
        ...
        if(leftIndex < v.size()){
            ...
            root0.left = new Node(v.get(leftIndex)); 
            create(root0.left, v, leftIndex);
       ...
       int rightIndex = i*2  + 2 ;
        ...
        if(rightIndex < v.size()){
            root0.right = new Node(v.get(rightIndex)); ;
            create(root0.right, v, rightIndex);    
        }
    }
}